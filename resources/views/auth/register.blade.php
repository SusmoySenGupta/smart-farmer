<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
            ...
            <div class="mt-4">
                ...
                <div class="flex mt-1">
                    ...
                    <x-text-input id="mobile_no" class="block w-full rounded-l-none" type="number" name="mobile_no" maxlength="10" minlength="10" :value="old('mobile_no')" required />
                </div>
        ...
        <div class="mt-4">
            ...
            <x-select-input id="role" name="role" class="w-full mt-1">
