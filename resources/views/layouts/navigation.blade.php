        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="/">
                        <x-application-logo class="block w-auto text-green-500 fill-current h-9" />
                    </a>
                </div>
            ...
            <div class="flex items-center justify-end w-full ">
                <button id="theme-toggle" type="button" class="flex justify-end p-2 text-sm text-gray-500 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700">
