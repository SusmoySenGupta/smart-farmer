<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="mt-4">
            ...
            <div class="flex mt-1">
                <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">+880</span>
                <x-text-input id="mobile_no" class="block w-full rounded-l-none" type="number" name="mobile_no" maxlength="10" minlength="10" :value="old('mobile_no', $user->mobile_no)" required />
            </div>
