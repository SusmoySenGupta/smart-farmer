        ...
        <div class="container flex flex-col flex-wrap items-center p-5 mx-auto md:flex-row">
            ...
            <div class="flex items-center gap-4">
                <div class="relative inline-flex">
                    <a href="#" class="inline-flex items-center px-3 py-1 mt-4 text-base bg-gray-100 border-0 rounded focus:outline-none hover:bg-gray-200 md:mt-0">
                        Cart
                    </a>
                </div>
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 pt-12 pb-24 mx-auto">
                ...
                @foreach (range(1, 8) as $products)
                    <div class="w-full p-4 border rounded-md ">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <div>
                                <button class="inline-flex items-center px-3 py-1 mt-4 text-xs font-medium text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-1">
            ...
            <div class="flex flex-col w-full mt-20 text-center">
                <a href="#" class="text-lg font-medium tracking-widest text-indigo-500 title-font">
                    View all
                </a>
            </div>
        </div>
